...
void loop() 
...

        {
          ...
          digitalWrite(buzzer, HIGH);//keep the buzzer quite
...
void floor1function()
       ...
       
        {
                     ...
                     if(floor1sense  != LOW) // check the proximity sensor of the first floor to see if the elevator is there
                    
                              {//if the elevator isn't there call it
                                
                                while( floor1sense==HIGH) //check that the proximity of the first floor is low
                                 //the motor begins and stops when the appropriate floor proximity give the signal
                                    ...
                                    digitalWrite(buzzer, LOW);//some noise in the mic
                                    floor1sense = digitalRead(floor1);
...
void floor2function()
        ...
        
        {
                            ...
                            if(floor3sense  == LOW) // check the proximity sensor of the third floor to see if the elevator is there
                          
                                              {//if the elevator is there call it
                                                
                                                while( floor2sense==HIGH)//the motor begins and stops when the appropriate floor proximity give the signal 
                              ...
                              else if(floor1sense  == LOW) // check the proximity sensor of the first floor to see if the elevator is there
...
void floor3function()
        ...
        
        {
                           ...
                           if(floor2sense  == LOW || floor1sense  == LOW) // check the proximity sensor of the first and second floor to see if the elevator is there
                                    
                                              {//if the elevator is there call it
                                                
                                                while( floor3sense==HIGH) //the motor begins and stops when the appropriate floor proximity give the signal
